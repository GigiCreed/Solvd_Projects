package solvd.projects.database.dbservices.jdbc.dao;
...
public class DeccansDAO extends AbstractMySqlDAO implements IDeccansDAO {
    ...
    public void create(Deccans deccans)  {
        ...
        try {
            ...
            preparedStatement.setInt(5,deccans.getPhoneNumber());
        ...
        try {
            switch (setParameter) {
                ...
                case "phone_number" -> {
                    ...
                    preparedStatementPhoneNumber.setInt(1, deccans.getPhoneNumber());
                ...
                case "all" -> {
                    ...
                    preparedStatementAll.setInt(5, deccans.getPhoneNumber());
